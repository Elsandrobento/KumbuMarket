      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 text-xs text-muted-foreground">
              ...
              <a href="#" className="hover:text-primary transition-colors">Planos Premium & Monetização</a>
              <a href="#" className="hover:text-primary transition-colors">Termos & Condições de Uso</a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hover:text-primary cursor-pointer transition-all underline">Português</span>
